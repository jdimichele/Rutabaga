...
var capacitorExports = (function (e) {
  ...
  const s = (t) => {
      ...
      const l = t.CapacitorCustomPlatform || null,
        ...
        p =
          (null === (n = null == u ? void 0 : u.currentPlatform) || void 0 === n
            ? void 0
            : n.getPlatform) ||
          (() =>
            null !== l
        ...
        f =
          ...
          ((e) => {
            const t = g.get(e);
            return !!(null == t ? void 0 : t.platforms.has(p())) || !!w(e);
          }),
        w =
            ...
            const u = (r) => {
                ...
                const u = (...u) => {
                  const p = (async () => (
                    !a && i in n
                      ? (a = a =
                          "function" == typeof n[i] ? await n[i]() : n[i])
                      : null !== l &&
                        !a &&
                        "web" in n &&
                        (a = a =
                          "function" == typeof n.web ? await n.web() : n.web),
                    a
                  ))().then((n) => {
                    const a = ((n, r) => {
                      var a, l;
                      ...
                      }
                      {
                        const e =
                          null == s
                            ? void 0
                            : s.methods.find((e) => r === e.name);
                        if (e)
                          return "promise" === e.rtype
                            ? (e) => c.nativePromise(t, r.toString(), e)
                            : (e, n) => c.nativeCallback(t, r.toString(), e, n);
                        if (n)
                          return null === (a = n[r]) || void 0 === a
                            ? void 0
                            : a.bind(n);
                      }
                    })(n, r);
                ...
                return (
                  (u.toString = () => `${r.toString()}() { [capacitor code] }`),
      ...
      return (
        ...
        (c.pluginMethodNoop = (e, t, n) =>
          Promise.reject(`${n} does not have an implementation of "${t}".`)),
        (c.registerPlugin = h),
        (c.Exception = o),
        (c.DEBUG = !!c.DEBUG),
  ...
  const f = l("CapacitorCookies", { web: () => new m() }),
    w = (e, t = {}) => {
  ...
  const h = l("CapacitorHttp", { web: () => new g() });
  return (
    (e.Capacitor = a),
    (e.CapacitorCookies = f),
    ...
    (e.registerWebPlugin = (e) =>
      ((e, t) => {
        ...
        console.warn(
          ...
          (i[r.name] &&
            !(null === (n = null == r ? void 0 : r.platforms) || void 0 === n
              ? void 0
